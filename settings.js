...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "MALVIN-XD~BkIRATwZ#wkvPjfO3-CAKrlDWnljTbVN6KjUKDR8Y8TJoZEuJNXU",// add your Session Id 

PREFIX: process.env.PREFIX || ".",
// add your prifix for bot

BOT_NAME: process.env.BOT_NAME || "toxii",
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "0711280556",
// add your bot owner number

OWNER_NAME: process.env.OWNER_NAME || "fred",
// add bot owner name
